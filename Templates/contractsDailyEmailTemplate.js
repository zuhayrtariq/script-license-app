...
const contractsDailyEmailTemplate = async(data,emailToName) =>{
  let emailHTML = `
    ...
    <tbody>
      <tr style="width:100%">
        <td><img alt="Prime Logo" src="https://piogcl.com/site2/wp-content/uploads/2023/11/prime-main-logo.png" style="display:block;outline:none;border:none;text-decoration:none;margin-top:0px;margin-bottom:0px;margin-left:auto;margin-right:auto" height="60" />
          <p style="font-size:14px;line-height:24px;margin:16px 0">Dear ${emailToName},</p>
          <p style="font-size:14px;line-height:24px;margin:16px 0">The Contracts below are expiring in ${process.env.Contract_Expiry_Limit_Months} months. You are requested to kindly raise requisition against the contracts. If the requisition is raised, kindly provide the updated status against the on-going requisitions.</p>
                  ...
                  <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" >
                    <tbody style="width:100%">
                      <tr  style="background-color:rgb(54,153,70);text-align:center;color:rgb(255,255,255);font-weight:700;border-radius:5em;overflow:hidden;fontSize:16px;border: 5px solid black;">
                        ...
                        <td style="letter-spacing: 0.5px;font-family:Arial,sans-serif;font-size: 15px;min-width:130px;">Requisition No.</td>
...
module.exports = contractsDailyEmailTemplate;