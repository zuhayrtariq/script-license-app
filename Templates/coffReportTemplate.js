...
const coffReportTemplate = async(data) =>{
  let emailHTML = `
    ...
    <tbody>
      <tr style="width:100%">
        <td><img alt="Prime Logo" src="https://piogcl.com/site2/wp-content/uploads/2023/11/prime-main-logo.png" style="display:block;outline:none;border:none;text-decoration:none;margin-top:0px;margin-bottom:0px;margin-left:auto;margin-right:auto" height="60" />
          ...
          <p style="font-size:14px;line-height:24px;margin:16px 0">The following call-offs have either expired or are expiring with-in ${process.env.Coff_Expiry_Limit_Days} days. You are requested to kindly confirm if extension/renewal is required. Please share details for extension.</p>
...
module.exports = coffReportTemplate;